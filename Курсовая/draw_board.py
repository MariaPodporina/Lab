...
class Worker(QRunnable):
    def __init__(self, task, parent=None):
        ...
        :task: Функция, которая будет запущена в другом потоке
...
class DrawBoard(QDialog):
    def __init__(self, size, l, coords, parent):
        ...
        :size: Размер шахматной доски
        :l: Количество фигур, необходимых расставить
        :coords: Список координат фигур уже поставленных
        :parent: Родительский класс
        """
